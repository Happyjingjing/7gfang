<template>
  <div class="groupinfo">
    ...
    <div class="txtbox">
      ...
      <p>
        报名人数：
        <span>{{ groupinfo.group_people_num }}</span>人已报名
      </p>
    ...
    <div class="txtjieshao">
      ...
      <p v-if="groupinfo.property_right_val">
        产权年限：
        <span v-for="(item, index) in groupinfo.property_right_val"
              :key="index">{{ item }}年</span>
      </p>
      ...
      <p>
        交房时间： {{ groupinfo.deliver_date ? groupinfo.deliver_date : "暂无数据" }}
      </p>
      <p>
        开盘时间：{{ groupinfo.start_time ? groupinfo.start_time : "暂无数据" }}
      </p>
      <p>
        物业公司： {{ groupinfo.property_company ? groupinfo.property_company : "暂无数据" }}
      </p>
      <p>
        售楼地址： {{ groupinfo.sale_address ? groupinfo.sale_address : "暂无数据" }}
      </p>
    </div>
    <p class="lijibm"
       @click="lijibm">立即报名</p>
