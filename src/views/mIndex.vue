  ...
  <div class="mindex">
    ...
    <div class="navbox">
      ...
      <ul>
        <li>
          <p class="red">
            <span>{{averagedata.avg}}元</span>/m²</p>
          <p>最新均价</p>
        </li>
        <li>
          <p class="green"
             v-if="averagedata.status==1">-{{averagedata.price_scope}}%</p>
          <p class="redd"
             v-else>+{{averagedata.price_scope}}%</p>
          <p>比上月</p>
        </li>
        <li>
          <p class="green"
             v-if="averagedata.year_status==1">-{{averagedata.year_ago}}%</p>
          <p class="redd"
             v-else>+{{averagedata.year_ago}}%</p>
          <p>比去年</p>
        </li>
      </ul>
    </div>
    <div class="zixunbox">
      ...
      <!-- :zxbigpic="zxbigpic" -->
      <zxbigpic :title="newsTop.post_title"
      ...
      <router-link tag="div"
                   ...
                   :key="item.n_id"
                   :nowurl="nowurl">
        <zxthreepic v-if="item.img_num == 3"
