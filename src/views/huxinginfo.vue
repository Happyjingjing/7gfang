    ...
    <div class="housebox">
      <div class="houseinfo">
        <h1 v-if="info.apartment_shi">
          {{ info.apartment_shi | replace }}室{{ info.apartment_ting | replace }}厅{{ info.apartment_wei | replace }}卫-{{ info.house_area }}m²
        </h1>
        <p class="tag">
          <span>户型方正</span>
          <span>南北通透</span>
        ...
        <div class="txtbox">
          ...
          <div class="lineblock">
            <p>
              建筑面积
              <span class="hui"
                    v-if="info.house_area">{{ info.house_area }}m²</span>
              <span class="hui"
                    v-else>暂无数据</span>
            </p>
            <p>
              套内面积
              <span class="hui"
                    v-if="info.status">{{ info.status }} </span>
              <span class="hui"
                    v-else>暂无数据</span>
            </p>
          </div>
