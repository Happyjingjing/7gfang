<template>
  <div class="searchsub">
    ...
    <div class="searchhead clearfix">
      <search @searchwordfu="searchwordfu"
    ...
    <div class="searchsubbox"
         ...
         @click.stop="fixblank">
      <ul class="searchul">
        <li @click.stop="getSonAreaListData"
            :class="{ on: quyudownshow }">
          <p>
            <span>区域</span>
            <i></i>
          </p>
        </li>
        <li @click.stop="getPriceListData"
            :class="{ on: jiagedownshow }">
          <p>
            <span>均价</span>
            <i></i>
          </p>
        </li>
        <li @click.stop="getapartmentListData"
            :class="{ on: huxingdownshow }">
          <p>
            <span>户型</span>
            <i></i>
          </p>
      ...
      <div class="seardownbox"
        ...
        <div class="downsel">
          ...
          <ul class="rigsel"
              v-show="quyushow">
            <li v-for="(item, index) in quyuList"
                :key="item.id"
        ...
        <div class="bombox">
          <p class="reset"
             @click.stop="reset">重置</p>
          <p class="define"
             @click.stop="define">确定</p>
        </div>
      </div>

      <div class="seardownbox"
           v-show="jiagedownshow">
        <div class="downsel">
          <ul class="lefsel">
            <li class="on">单价</li>
          </ul>
      ...
      <div class="seardownbox"
           v-show="huxingdownshow">
        <div class="downsel">
          <ul class="rigsel huxing">
            <li v-for="(item, index) in huxingList"
                :key="item.h_id"
    ...
    <div class="searchsubbd">
      <!-- {{tuijlpList}} -->
      <tuijianlp :tuijlpList="tuijlpList"
                 :nowurl="nowurl" />
      <p class="morelp"
         v-if="!nodata">
        {{ nomore ? "没有更多了" : "正在加载..." }}
...
export default {
  ...
  created () {
    ...
    this.$emit("navtxt", this.nowplace + "楼市");
